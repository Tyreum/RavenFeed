...
export default function Chat(){
    return(
        <div class="container">
        <div class="menu">
            <div class="back"><i class="fa fa-chevron-left"></i> <img src="https://i.pinimg.com/originals/ff/8f/4f/ff8f4f855599bf585b513c5378c6fb86.jpg" draggable="false"/></div>
            <div class="name">Alex</div>
            <div class="last">18:09</div>
        </div>
    <ol class="chat">
    <li class="other">
        <div class="avatar"><img src="https://i.pinimg.com/originals/ff/8f/4f/ff8f4f855599bf585b513c5378c6fb86.jpg" draggable="false"/></div>
      <div class="msg">
        <p>Hola!</p>
